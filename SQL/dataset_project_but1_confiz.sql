...
(1, 'Bonbon Acide', 'Acide', 1.99, 'img/img_bdd/bonbon acide.png', 'Bonbon acide délicieux'),
(2, 'Caramel', 'Douceur', 2.49, 'img/img_bdd/caramel.png', 'Caramel fondant au beurre salé'),
(3, 'Chocolat Noir', 'Chocolat', 3.99, 'img/img_bdd/chocolatn.png', 'Chocolat noir à 70% de cacao'),
(4, 'Dragée', 'Fête', 4.99, 'img/img_bdd/dragée.png', 'Dragées pour les mariages et baptêmes'),
(5, 'Sucette', 'Classique', 1.50, 'img/img_bdd/sucette.png', 'Sucette aux fruits rouges'),
(6, 'Nougat', 'Douceur', 2.99, 'img/img_bdd/nougat.png', 'Nougat tendre avec des amandes'),
(7, 'Gomme', 'Fruité', 1.75, 'img/img_bdd/gomme.png', 'Gommes aux fruits assortis'),
(8, 'Réglisse', 'Classique', 1.89, 'img/img_bdd/reglisse.png', 'Bonbon à la réglisse'),
(9, 'Praline', 'Gourmandise', 5.49, 'img/img_bdd/', 'Praline enrobée de chocolat'),
(10, 'Menthe', 'Frais', 1.20, 'img/img_bdd/', 'Bonbon à la menthe rafraîchissante'),
(11, 'Bonbon Acidulé', 'Acide', 2.30, 'img/img_bdd/', 'Bonbon acidulé aux agrumes'),
(12, 'Fudge', 'Douceur', 3.50, 'img/img_bdd/', 'Fudge crémeux au chocolat'),
(13, 'Chocolat au Lait', 'Chocolat', 2.99, 'img/img_bdd/', 'Chocolat au lait onctueux'),
(14, 'Guimauve', 'Fête', 3.00, 'img/img_bdd/', 'Guimauve moelleuse'),
(15, 'Sucette Tournante', 'Classique', 2.00, 'img/img_bdd/', 'Sucette tournante multicolore'),
(16, 'Pâte de Fruits', 'Fruité', 4.00, 'img/img_bdd/', 'Pâte de fruits à la framboise'),
(17, 'Bonbon Fourré', 'Gourmandise', 3.20, 'img/img_bdd/', 'Bonbon fourré au caramel'),
(18, 'Gomme Arlequin', 'Classique', 2.50, 'img/img_bdd/', 'Gomme multicolore'),
(19, 'Caramel au Beurre', 'Douceur', 1.99, 'img/img_bdd/', 'Caramel fondant au beurre doux'),
(20, 'Chocolat Blanc', 'Chocolat', 4.49, 'img/img_bdd/', 'Chocolat blanc vanillé'),
(21, 'Bonbon Miel', 'Frais', 1.80, 'img/img_bdd/', 'Bonbon au miel de montagne'),
(22, 'Nougatine', 'Gourmandise', 3.75, 'img/img_bdd/', 'Nougatine croustillante'),
(23, 'Menthe Forte', 'Frais', 1.50, 'img/img_bdd/', 'Bonbon à la menthe forte'),
(24, 'Bonbon Gélifié', 'Fruité', 2.20, 'img/img_bdd/', 'Bonbon gélifié aux fruits tropicaux'),
(25, 'Caramel Dur', 'Classique', 1.60, 'img/img_bdd/', 'Caramel dur et croquant'),
