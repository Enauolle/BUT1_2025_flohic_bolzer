...
(2, 'OK Bonbons', 2, '20', 'Avenue des Friandises', '69001', 'Lyon', 'France', 'B2.png', 'Bienvenue dans le monde coloré de OK Bonbon, un univers où la nostalgie flirte avec la fantaisie, et où chaque bouchée est une fête en soi. Ici, pas de chichis, juste du bon, du fun, et une bonne dose de souvenirs sucrés.
...
(3, 'Saccharo', 3, '30', 'Boulevard des Saveurs', '13001', 'Marseille', 'France', 'B3.png', 'Saccharo n’est pas une simple maison de douceurs : c’est un laboratoire d’émotions sucrées, un théâtre des sens où l’art de la confiserie devient une exploration sensorielle. À la croisée des rituels anciens et des expériences nouvelles, Saccharo célèbre le sucre dans toute sa complexité, sa poésie, sa puissance évocatrice.
...
(1, 'Bonbon Acide', 'Acide', 1.99, 'bonbon acide.png', 'Bonbon acide délicieux'),
(2, 'Caramel', 'Douceur', 2.49, 'caramel.png', 'Caramel fondant au beurre salé'),
(3, 'Chocolat Noir', 'Chocolat', 3.99, 'chocolatn.png', 'Chocolat noir à 70% de cacao'),
(4, 'Dragée', 'Fête', 4.99, 'dragée.png', 'Dragées pour les mariages et baptêmes'),
(5, 'Sucette', 'Classique', 1.50, 'sucette.png', 'Sucette aux fruits rouges'),
(6, 'Nougat', 'Douceur', 2.99, 'nougat.png', 'Nougat tendre avec des amandes'),
(7, 'Gomme', 'Fruité', 1.75, 'gomme.png', 'Gommes aux fruits assortis'),
(8, 'Réglisse', 'Classique', 1.89, 'reglisse.png', 'Bonbon à la réglisse'),
(9, 'Praline', 'Gourmandise', 5.49, 'praline.png', 'Praline enrobée de chocolat'),
(10, 'Menthe', 'Frais', 1.20, 'menthe.png', 'Bonbon à la menthe rafraîchissante'),
(11, 'Bonbon Acidulé', 'Acide', 2.30, 'acidulé.png', 'Bonbon acidulé aux agrumes'),
(12, 'Fudge', 'Douceur', 3.50, 'fudge.png', 'Fudge crémeux au chocolat'),
(13, 'Chocolat au Lait', 'Chocolat', 2.99, 'chocolatl.png', 'Chocolat au lait onctueux'),
(14, 'Guimauve', 'Fête', 3.00, 'guimauve.png', 'Guimauve moelleuse'),
(15, 'Sucette Tournante', 'Classique', 2.00, 'sucettet.png', 'Sucette tournante multicolore'),
(16, 'Pâte de Fruits', 'Fruité', 4.00, 'pate.png', 'Pâte de fruits à la framboise'),
(17, 'Bonbon Fourré', 'Gourmandise', 3.20, 'bonbonfourrés.png', 'Bonbon fourré au caramel'),
(18, 'Gomme Arlequin', 'Classique', 2.50, 'arlequin.png', 'Gomme multicolore'),
(19, 'Caramel au Beurre', 'Douceur', 1.99, 'caramelbeurresale.png', 'Caramel fondant au beurre doux'),
(20, 'Chocolat Blanc', 'Chocolat', 4.49, 'chocolatb.png', 'Chocolat blanc vanillé'),
(21, 'Bonbon Miel', 'Frais', 1.80, 'bonbonsmiel.png', 'Bonbon au miel de montagne'),
(22, 'Nougatine', 'Gourmandise', 3.75, 'nougatine.png', 'Nougatine croustillante'),
(23, 'Menthe Forte', 'Frais', 1.50, 'menthef.png', 'Bonbon à la menthe forte'),
(24, 'Bonbon Gélifié', 'Fruité', 2.20, 'gélifié.png', 'Bonbon gélifié aux fruits tropicaux'),
(25, 'Caramel Dur', 'Classique', 1.60, 'carameldur.png', 'Caramel dur et croquant'),
(26, 'Chocolat Praliné', 'Chocolat', 3.80, 'chocopraline.png', 'Chocolat praliné noisette'),
(27, 'Bonbon à l\'Orange', 'Fruité', 1.99, 'orange.png', 'Bonbon à l\'orange acidulé'),
(28, 'Réglisse Douce', 'Classique', 1.70, 'reglissed.png', 'Réglisse douce et sucrée'),
(29, 'Caramel Mou', 'Douceur', 2.10, 'caramelmou.png', 'Caramel mou et tendre'),
(30, 'Chocolat Noir Intense', 'Chocolat', 5.00, 'intense.png', 'Chocolat noir intense 85% de cacao'),
(31, 'Sucette Fruitée', 'Classique', 1.75, 'sucettefruit.png', 'Sucette fruitée assortie'),
(32, 'Dragée au Chocolat', 'Fête', 3.99, 'drageechoco.png', 'Dragée au chocolat pour les fêtes'),
(33, 'Nougat Blanc', 'Douceur', 3.25, 'nougatb.png', 'Nougat blanc avec des pistaches'),
(34, 'Gomme Fruitée', 'Fruité', 2.50, 'gommefruit.png', 'Gomme fruitée mixte'),
(35, 'Bonbon à la Fraise', 'Fruité', 1.90, 'fraise.png', 'Bonbon à la fraise sucrée'),
(36, 'Caramel au Sel', 'Douceur', 2.75, 'caramelsalé.png', 'Caramel au beurre salé'),
(37, 'Chocolat au Noisette', 'Chocolat', 4.00, 'noisette.png', 'Chocolat au lait avec des noisettes entières'),
(38, 'Bonbon à la Menthe', 'Frais', 1.50, 'bonbonmenthe.png', 'Bonbon à la menthe rafraîchissante'),
(39, 'Pâte à Sucre', 'Classique', 2.30, 'patesucre.png', 'Pâte à sucre colorée'),
(40, 'Caramel Croquant', 'Douceur', 2.99, 'croquant.png', 'Caramel croquant au beurre'),
(41, 'Guimauve Fruitée', 'Fête', 2.80, 'guimauvefruit.png', 'Guimauve fruitée assortie'),
(42, 'Chocolat Fondant', 'Chocolat', 3.75, 'fondant.png', 'Chocolat fondant au lait'),
(43, 'Bonbon Réglisse', 'Classique', 1.99, 'bonbonregle.png', 'Bonbon à la réglisse pure'),
(44, 'Dragée Sucrée', 'Fête', 4.50, 'drageesucre.png', 'Dragée sucrée colorée'),
(45, 'Nougat Noir', 'Douceur', 3.50, 'nougatnoir.png', 'Nougat noir au miel'),
(46, 'Gomme à la Menthe', 'Frais', 1.70, 'chewingum.png', 'Gomme à la menthe verte'),
(47, 'Caramel au Chocolat', 'Douceur', 2.20, 'caramelchoco.png', 'Caramel enrobé de chocolat'),
(48, 'Bonbon Pétillant', 'Classique', 2.00, 'petille.png', 'Bonbon pétillant en bouche'),
(49, 'Chocolat Blanc Fraise', 'Chocolat', 4.20, 'chocofraise.png', 'Chocolat blanc à la fraise'),
(50, 'Sucette à la Cerise', 'Classique', 1.50, 'cerise.png', 'Sucette à la cerise acidulée');
